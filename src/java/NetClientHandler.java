...
{
    private static final String serverURLjoinserver = "http://89.189.180.47/node/joinserver.php?user=";
    private static final String serverName = "zombie_apocalypse";
    ...
    public NetClientHandler(Minecraft par1Minecraft, String par2Str, int par3) throws IOException
    {
        ...
        if (par2Str.equals("tunnel-1"))
        {
            par2Str = "89.189.180.47";
        }
        else if (par2Str.equals("tunnel-2"))
        {
            par2Str = "185.4.64.139";
        }
    ...
    private String func_72550_a(String par1Str, String par2Str, String par3Str)
    {
        try
        {
            URL var4 = new URL("http://89.189.180.47/node/joinserver.php?user=" + urlEncode(par1Str) + "&sessionId=" + urlEncode(par2Str) + "&serverId=" + urlEncode(par3Str) + "&serverName=" + "zombie_apocalypse");
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn)
    {
        ...
        else if (par1Packet23VehicleSpawn.type == 58)
        {
            var8 = new EntityPosuda(this.worldClient, var2, var4, var6, par1Packet23VehicleSpawn.kot525Par1);
        }
        else if (par1Packet23VehicleSpawn.type == 59)
        {
            var8 = new EntityBullet(this.worldClient, var2, var4, var6, par1Packet23VehicleSpawn.kot525Par1);
        }
        else if (par1Packet23VehicleSpawn.type == 60)
        {
            var8 = new EntityArrow(this.worldClient, var2, var4, var6, par1Packet23VehicleSpawn.kot525Par1);
        }
        ...
        if (var8 != null)
        {
            ...
            if (par1Packet23VehicleSpawn.throwerEntityId > 0)
            {
                ...
                {
                    var14 = this.getEntityByID(par1Packet23VehicleSpawn.throwerEntityId);

                    if (var14 instanceof EntityLiving)
                    {
                        EntityArrow var15 = (EntityArrow)var8;
                        var15.shootingEntity = var14;
                    }
                }
                else if (par1Packet23VehicleSpawn.type == 59)
                {
                    ...
                    if (var14 instanceof EntityLiving)
                    {
                        EntityBullet var16 = (EntityBullet)var8;
                        var16.shootingEntity = var14;
                    }
                }
                else if (par1Packet23VehicleSpawn.type == 58)
                {
                    ...
                    if (var14 instanceof EntityLiving)
                    {
                        EntityPosuda var17 = (EntityPosuda)var8;
                        var17.thrower = (EntityLiving)var14;
                    }
                }
    ...
    public void handleAnimation(Packet18Animation par1Packet18Animation)
    {
        ...
        if (var2 != null)
        {
            ...
            else
            {
                ...
                if (par1Packet18Animation.animate == 3)
                {
                ...
                else if (par1Packet18Animation.animate != 4)
                {
                    ...
                    {
                        if (par1Packet18Animation.animate == 30)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.vspyshkaOrug = 1;
                        }
                        else if (par1Packet18Animation.animate == 31)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.pritsel = 100;
                        }
                        else if (par1Packet18Animation.animate == 32)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.perezaryadka = 1;
                            var4.tickFire = par1Packet18Animation.kot525Par1;
                        }
                        else if (par1Packet18Animation.animate == 33)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.perezaryadka = 2;
                            var4.tickFire = par1Packet18Animation.kot525Par1;
                        }
                        else if (par1Packet18Animation.animate == 34)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.perezaryadka = 3;
                            var4.tickFire = par1Packet18Animation.kot525Par1;
                        }
                        else if (par1Packet18Animation.animate == 35)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.gilza(1);
                        }
                        else if (par1Packet18Animation.animate == 36)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.smoke(true, par1Packet18Animation.kot525Par1);
                        }
                        else if (par1Packet18Animation.animate == 37)
                        {
                            var4 = (EntityPlayer)var2;
                            var4.korroziya = par1Packet18Animation.kot525Par1;
                        }
                    }
                }
            }
    ...
    public void handleEntityEffect(Packet41EntityEffect par1Packet41EntityEffect)
    {
        ...
        {
            if (par1Packet41EntityEffect.otlDeistvSvitch)
            {
                ((EntityLiving)var2).addPotionEffect(new PotionEffect(par1Packet41EntityEffect.effectId, par1Packet41EntityEffect.duration, par1Packet41EntityEffect.effectAmplifier, par1Packet41EntityEffect.otlDeistv, par1Packet41EntityEffect.koSvitch));
            }
            else
            {

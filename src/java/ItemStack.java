...
public final class ItemStack
{
    ...
    public ItemStack(int par1, int par2, int par3)
    {
        ...
        this.ItemStackSizeMax_kot525(par1);
    }
    ...
    public ItemStack(int var1, int var2, int var3, int var4)
    {
        ...
        this.stat1 = var4;
        this.ItemStackSizeMax_kot525(var1);
    }

    public void ItemStackSizeMax_kot525(int var1)
    {
        if (var1 != 145 && var1 != 379 && var1 != 380)
        {
            if (var1 == 22 || var1 == 41 || var1 == 42 || var1 == 46 || var1 == 54 || var1 == 57 || var1 == 133 || var1 == 226)
            {
                this.getItem().setMaxStackSize(6);
            }
        }
        else
        {
            this.getItem().setMaxStackSize(1);
        }
    }
    ...
    {
        ItemStack var2 = new ItemStack(this.itemID, par1, this.itemDamage, this.stat1);
    ...
    public ItemStack useItemRightClick(World var1, EntityPlayer var2, float var3, float var4)
    {
        return this.getItem().onItemRightClick(this, var1, var2, var3, var4);
    }

    public ItemStack useItemPerezaryadka(World var1, EntityPlayer var2)
    {
        return this.getItem().onItemPerezaryadka(this, var1, var2);
    }

    public ItemStack useItemRazryaditOruzhiye(World var1, EntityPlayer var2)
    {
        return this.getItem().onItemRazryaditOruzhiye(this, var1, var2);
    }

    public ItemStack useItemSmenaStrel(World var1, EntityPlayer var2)
    {
        return this.getItem().onItemSmenaStrel(this, var1, var2);
    }
    ...
    {
        par1NBTTagCompound.setShort("stat1", (short)this.stat1);
    ...
    {
        this.stat1 = par1NBTTagCompound.getShort("stat1");
    ...
    {
        ItemStack var1 = new ItemStack(this.itemID, this.stackSize, this.itemDamage, this.stat1);
    ...
    public List getTooltip(EntityPlayer par1EntityPlayer, boolean par2)
    {
        ...
        var3.add(var5);
        item.addInformation(this, par1EntityPlayer, var3, par2);

        if (item.isItemTool(this)) {
            int fulldur = item.getMaxDamage();
            int displdur = this.getItemDamageForDisplay();
            int currentdur = fulldur - displdur;
            String durability = "Dur: " + currentdur + 1 + "/" + fulldur + 1;
            String damage = "Damage: " + item.getDamageVsEntity(null);
            var3.add(damage);
            var3.add(durability);
        }

        if (this.hasTagCompound()) {
            NBTTagList var11 = this.getEnchantmentTagList();

            if (var11 != null) {
                for (int var7 = 0; var7 < var11.tagCount(); ++var7) {
                    short var13 = ((NBTTagCompound) var11.tagAt(var7)).getShort("id");
                    short var15 = ((NBTTagCompound) var11.tagAt(var7)).getShort("lvl");

                    if (Enchantment.enchantmentsList[var13] != null) {
                        var3.add(Enchantment.enchantmentsList[var13].getTranslatedName(var15));
                    }
                }
            }

            if (this.stackTagCompound.hasKey("display")) {
                NBTTagCompound var12 = this.stackTagCompound.getCompoundTag("display");

                if (var12.hasKey("color")) {
                    if (par2) {
                ...
                if (var12.hasKey("Lore")) {
                    NBTTagList var14 = var12.getTagList("Lore");

                    if (var14.tagCount() > 0) {
                        for (int var16 = 0; var16 < var14.tagCount(); ++var16) {
                            var3.add("\u00a75\u00a7o" + ((NBTTagString) var14.tagAt(var16)).data);
                        }
                    }
                }
            }

...
public class PlayerControllerMP
{
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else if (this.func_85182_a(par1, par2, par3))
        {
            int var5 = this.mc.theWorld.getBlockId(par1, par2, par3);
            ...
            this.curBlockDamageMP += var6.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, par1, par2, par3) * (H2Eng.fastbreak ? 1.6F : 1.0F);
    ...
    public void updateController()
    {
        ...
        var1 = (long)((int)(var1 % 48000L));

        if (var1 > 25000L && var1 < 26000L && !this.mc.thePlayer.capabilities.isCreativeMode && this.mc.theWorld.provider.getDimensionName().equals("Overworld"))
        {
            this.mc.sndManager.playMusicSerena();
        }
    }
    ...
    {
        if (par3ItemStack != null && par1EntityPlayer.isInsideOfMaterial(Material.water) && randCh.CHSPodVodoy(par3ItemStack.itemID))
        {
            return false;
        }
        else
    ...
    public boolean sendUseItem(EntityPlayer var1, World var2, ItemStack var3, int var4)
    {
        this.syncCurrentPlayItem();
        float var5 = 0.0F;
        float var6 = 0.0F;
        ...
        if (var4 == 5)
        {
            var5 = var2.rand.nextFloat();
            var6 = var2.rand.nextFloat();
        }
        ...
        {
            this.netClientHandler.addToSendQueue(new Packet15Place(-1, -1, -1, 255, var1.inventory.getCurrentItem(), 0.0F, 0.0F, 0.0F, 2));
        }
        else if (var4 == 3)
        {
            this.netClientHandler.addToSendQueue(new Packet15Place(-1, -1, -1, 255, var1.inventory.getCurrentItem(), 0.0F, 0.0F, 0.0F, 3));
        }
        else if (var4 == 4)
        {
            this.netClientHandler.addToSendQueue(new Packet15Place(-1, -1, -1, 255, var1.inventory.getCurrentItem(), 0.0F, 0.0F, 0.0F, 4));
        }
        else if (var4 == 5)
        {
            this.netClientHandler.addToSendQueue(new Packet15Place(-1, -1, -1, 255, var1.inventory.getCurrentItem(), 0.0F, 0.0F, 0.0F, 1, var5, var6));
        }

        int var7 = var3.stackSize;
        ItemStack var8 = null;

        if (var4 == 1)
        {
            var8 = var3.useItemRightClick(var2, var1);
        }
        else if (var4 == 2)
        {
            var8 = var3.useItemPerezaryadka(var2, var1);
        }
        else if (var4 == 3)
        {
            var8 = var3.useItemRazryaditOruzhiye(var2, var1);
        }
        else if (var4 == 4)
        {
            var8 = var3.useItemSmenaStrel(var2, var1);
        }
        else if (var4 == 5)
        {
            var8 = var3.useItemRightClick(var2, var1, var5, var6);
        }

        if (var8 == var3 && (var8 == null || var8.stackSize == var7))
        {
            return false;
        }
        else
        {
            var1.inventory.mainInventory[var1.inventory.currentItem] = var8;

...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        {
            this.skinUrl = "http://survival-minecraft.ru/node/upload/zombie_apocalypse/skins/" + StringUtils.stripControlCodes(par3Session.username) + ".png";
        }
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            if (!H2Eng.noslow && this.isUsingItem()) {
    ...
    {
        this.playerCloakUrl = "http://survival-minecraft.ru/node/upload/zombie_apocalypse/cloaks/" + StringUtils.stripControlCodes(this.username) + ".png";

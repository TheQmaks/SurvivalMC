...
public class Block
{
    ...
    public static final Block bed = (new BlockBed(26)).setHardness(3.0F).setBlockName("bed").disableStats().setRequiresSelfNotify();
    ...
    public static final Block blockSteel = (new BlockOreStorage(42, 22)).setHardness(30.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockIron");

    /** stoneDoubleSlab */
    public static final BlockHalfSlab stoneDoubleSlab = (BlockHalfSlab)(new BlockStep(43, true)).setHardness(8.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");

    /** stoneSingleSlab */
    public static final BlockHalfSlab stoneSingleSlab = (BlockHalfSlab)(new BlockStep(44, false)).setHardness(8.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
    public static final Block brick = (new Block(45, 7, Material.rock)).setHardness(12.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("brick").setCreativeTab(CreativeTabs.tabBlock);
    ...
    public static final Block doorSteel = (new BlockDoor(71, Material.iron)).setHardness(10.0F).setStepSound(soundMetalFootstep).setBlockName("doorIron").disableStats().setRequiresSelfNotify();
    ...
    public static final Block stoneBrick = (new BlockStoneBrick(98)).setHardness(7.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("stonebricksmooth");
    ...
    public static final Block fenceIron = (new BlockPane(101, 85, 85, Material.iron, true)).setHardness(35.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("fenceIron");
    ...
    public static final Block kislotaMoving = (new BlockFlowing(215, Material.water)).setHardness(100.0F).setLightOpacity(3).setBlockName("kislota").disableStats().setRequiresSelfNotify();
    public static final Block kislotaStill = (new BlockStationary(216, Material.water)).setHardness(100.0F).setLightOpacity(3).setBlockName("kislota").disableStats().setRequiresSelfNotify();
    public static final Block titan = (new BlockBeton(217, 27)).setHardness(9000000.0F).setResistance(2000.0F).setStepSound(soundMetalFootstep).setBlockName("titan");
    public static final Block labBlock = (new BlockBeton(218, 26)).setHardness(1500.0F).setResistance(7.0F).setStepSound(soundMetalFootstep).setBlockName("labBlock");
    public static final Block zAntiRad = (new BlockZaraza2(219, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zAntiRad");
    public static final Block korrozionnoyeOblako = (new BlockKorrozionnoyeOblako(220, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("korrozionnoyeOblako");
    public static final Block rzhavoyeZhelezo = (new BlockRzhavoyeZhelezo(221, 234)).setHardness(30.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("rzhavoyeZhelezo");
    public static final Block lavaMoving2 = (new BlockFlowing(222, Material.lava)).setHardness(0.0F).setLightValue(1.0F).setLightOpacity(255).setBlockName("lava2").disableStats().setRequiresSelfNotify();
    public static final Block lavaStill2 = (new BlockStationary(223, Material.lava, true)).setHardness(0.0F).setLightValue(1.0F).setLightOpacity(255).setBlockName("lava2").disableStats().setRequiresSelfNotify();
    public static final Block netherrack2 = (new BlockNetherrack2(224, 16)).setHardness(1.5F).setStepSound(soundStoneFootstep).setBlockName("hellrock2");
    public static final Block kolyuchayaProvoloka = (new BlockKolyuchayaProvoloka(225, 220)).setLightOpacity(1).setHardness(60.0F).setResistance(10.0F).setBlockName("kolyuchayaProvoloka");
    public static final Block uranium = (new BlockUranium(226, 235)).setHardness(12.0F).setLightValue(0.6F).setStepSound(soundMetalFootstep).setBlockName("uranium").setRequiresSelfNotify();
    public static final Block lampaBlock = (new BlockLampaBlock(227, 221)).setHardness(0.2F).setLightValue(1.0F).setStepSound(soundGlassFootstep).setBlockName("lampaBlock").setRequiresSelfNotify();
    public static final Block asfalt = (new Block(228, 219, Material.rock)).setHardness(5.0F).setResistance(2.0F).setStepSound(soundStoneFootstep).setBlockName("asfalt").setCreativeTab(CreativeTabs.tabBlock);
    public static final BlockHalfSlab asfaltSlab = (BlockHalfSlab)(new BlockAsfaltSlab(229, false)).setHardness(5.0F).setResistance(2.0F).setStepSound(soundStoneFootstep).setBlockName("asfaltSlab");
    public static final Block zombie_zaslon = (new BlockZaraza2(230, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zombie_zaslon");
    public static final Block vspyshka = (new BlockVspyshka(231, 180)).setHardness(1.0F).setLightValue(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("vspyshka");
    public static final Block obrNevidimayaPlita = (new BlockObrNevidimayaPlita(232, 180, EnumMobType.mobs, Material.zaraza)).setHardness(0.5F).setStepSound(soundStoneFootstep).setBlockName("obrNevidimayaPlita").setRequiresSelfNotify();
    public static final Block nevidimayaPlita = (new BlockNevidimayaPlita(233, 180, EnumMobType.mobs, Material.zaraza)).setHardness(0.5F).setStepSound(soundStoneFootstep).setBlockName("nevidimayaPlita").setRequiresSelfNotify();
    public static final Block torchWood2 = (new BlockTorch2(234, 188)).setHardness(0.0F).setLightValue(0.9F).setStepSound(soundWoodFootstep).setBlockName("torch2").setRequiresSelfNotify();
    public static final Block torchWood3 = (new BlockTorch3(235, 189)).setHardness(0.0F).setLightValue(0.8F).setStepSound(soundWoodFootstep).setBlockName("torch3").setRequiresSelfNotify();
    public static final Block torchWood4 = (new BlockTorch4(236, 190)).setHardness(0.0F).setLightValue(0.5F).setStepSound(soundWoodFootstep).setBlockName("torch4").setRequiresSelfNotify();
    public static final Block torchWood5 = (new BlockTorch5(237, 191)).setHardness(0.0F).setStepSound(soundWoodFootstep).setBlockName("torch5").setRequiresSelfNotify();
    public static final Block lampa = (new BlockLampa(238, 187)).setHardness(0.1F).setLightValue(1.0F).setStepSound(soundGlassFootstep).setBlockName("lampa").setRequiresSelfNotify();
    public static final Block beton = (new BlockBetonS(239, 1)).setBlockUnbreakable().setResistance(2000.0F).setStepSound(soundStoneFootstep).setBlockName("beton");
    public static final Block beton2 = (new BlockBetonS(240, 1)).setHardness(150.0F).setResistance(7.0F).setStepSound(soundStoneFootstep).setBlockName("beton2");
    public static final Block beton3 = (new BlockBeton(241, 218)).setHardness(150.0F).setResistance(7.0F).setStepSound(soundStoneFootstep).setBlockName("beton3");
    public static final Block beton4 = (new BlockBeton(242, 218)).setHardness(450.0F).setResistance(7.0F).setStepSound(soundStoneFootstep).setBlockName("beton4");
    public static final Block beton5 = (new BlockBeton(243, 218)).setHardness(1500.0F).setResistance(7.0F).setStepSound(soundStoneFootstep).setBlockName("beton5");
    public static final Block zaraza = (new BlockZaraza(244, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza");
    public static final Block zaraza2 = (new BlockZaraza(245, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza2");
    public static final Block zaraza3 = (new BlockZaraza(246, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza3");
    public static final Block zaraza4 = (new BlockZaraza2(247, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza4");
    public static final Block zaraza5 = (new BlockZaraza2(248, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza5");
    public static final Block zaraza6 = (new BlockZaraza2(249, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza6");
    public static final Block zaraza7 = (new BlockZaraza2(250, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza7");
    public static final Block zaraza8 = (new BlockZaraza2(251, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza8");
    public static final Block zaraza9 = (new BlockZaraza2(252, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza9");
    public static final Block zaraza10 = (new BlockZaraza2(253, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza10");
    public static final Block zaraza11 = (new BlockZaraza2(254, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza11");
    public static final Block zaraza12 = (new BlockZaraza2(255, 180)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("zaraza12");
    ...
    {
        return H2Eng.xray ? H2Eng.isBlockExists(blockID) && setLightValue(1) != null : par5 == 0 && this.minY > 0.0D ? true : (par5 == 1 && this.maxY < 1.0D ? true : (par5 == 2 && this.minZ > 0.0D ? true : (par5 == 3 && this.maxZ < 1.0D ? true : (par5 == 4 && this.minX > 0.0D ? true : (par5 == 5 && this.maxX < 1.0D ? true : !par1IBlockAccess.isBlockOpaqueCube(par2, par3, par4))))));
    }
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6)
    {
        ...
        if (par2EntityPlayer.posY < 20.0D)
        {
            par2EntityPlayer.addExhaustion(0.3F);
        }
        else if (par2EntityPlayer.posY < 30.0D)
        {
            par2EntityPlayer.addExhaustion(0.2F);
        }
        else
        {
    ...
    {
        if (this.blockID <= 145 || Minecraft.ramWhiteList || this.blockWhiteList(this.blockID))
        {
    ...
    private boolean blockWhiteList(int var1)
    {
        return var1 == 217 || var1 == 218 || var1 == 221 || var1 == 222 || var1 == 223 || var1 == 225 || var1 == 226 || var1 == 227 || var1 == 228 || var1 == 229 || var1 == 234 || var1 == 235 || var1 == 236 || var1 == 237 || var1 == 238 || var1 == 240 || var1 == 241 || var1 == 242 || var1 == 244;
    }

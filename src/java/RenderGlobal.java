...
public class RenderGlobal implements IWorldAccess
{
    ...
    {
        if (H2Eng.chestesp) {
            for (TileEntity e : (List<TileEntity>) mc.theWorld.loadedTileEntityList) {
                if (e instanceof TileEntityChest || e instanceof TileEntityEnderChest) {
                    ...
                    if (mc.theWorld.blockHasTileEntity(e.xCoord, e.yCoord, e.zCoord)) {
                        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
                        if (e instanceof TileEntityChest) {
                            GL11.glColor4f(255.0F, 255.0F, 0.0F, 1.0F);
                        } else {
                            GL11.glColor4f(128.0F, 0.0F, 255.0F, 1.0F);
                        }
                        GL11.glLineWidth(1.0F);
                        GL11.glDisable(GL11.GL_TEXTURE_2D);
                        GL11.glDisable(GL11.GL_DEPTH_TEST);
                        GL11.glDepthMask(false);
                        drawOutlinedBoundingBox(AxisAlignedBB.getBoundingBox(x + 1.0D, y + 1.0D, z + 1.0D, x, y, z));
        ...
        if (H2Eng.tracers) {
            for (Entity e : (List<Entity>) mc.theWorld.loadedEntityList) {
                if ((e != mc.renderViewEntity) && (e.isEntityAlive())) {
                    double pX = e.lastTickPosX + (e.posX - e.lastTickPosX) * par3
                            - RenderManager.renderPosX;
                    double pY = e.lastTickPosY + (e.posY - e.lastTickPosY) * par3
                            - RenderManager.renderPosY;
                    double pZ = e.lastTickPosZ + (e.posZ - e.lastTickPosZ) * par3
                    ...
                    for (int time = 1; time < 3; time++) {
                        ...
                        if (mc.thePlayer.getDistanceToEntity(e) < 8.0D) {
                            GL11.glColor4f(1.0F, 0.0F, 0.0F, time == 1 ? 0.5F : 1.0F);
                        } else {
                            GL11.glColor4d(1.0D, 0.0D + (mc.thePlayer.getDistanceToEntity(e) / 48.0D), 0.0D, time == 1 ? 0.5D : 1.0D);
                        }
                        if (e instanceof EntityPlayer) {
                            GL11.glBegin(GL11.GL_LINE_STRIP);
                            GL11.glVertex3d(0.0D, 0.0D, 0.0D);
                            GL11.glVertex3d(pX, pY, pZ);
                            GL11.glVertex3d(pX, pY + e.getEyeHeight(), pZ);
                            GL11.glEnd();
        ...
        if(H2Eng.esp) {
            for (Object o : mc.theWorld.loadedEntityList) {
                if ((o instanceof EntityPlayer) && (o != mc.thePlayer)) {
                    ...
                    double posX = (player.lastTickPosX + (player.posX - player.lastTickPosX) - RenderManager.renderPosX);
                    double posY = (player.lastTickPosY + (player.posY - player.lastTickPosY) - RenderManager.renderPosY);
                    double posZ = (player.lastTickPosZ + (player.posZ - player.lastTickPosZ) - RenderManager.renderPosZ);
                    ...
                    if (player.health > 0) {
                        if (player.health <= 5.0F)
                            health = health - 2;

                        if (player.health == 0)
                            health = health - 3;

                        H2Eng.drawRect(29.1F, (-player.health) * 3.8F, 30.3F, 8.0F, 0xFF37ae37);
                        H2Eng.drawRect(29.1F, (-player.getMaxHealth()) * 3.8F, 30.3F, (float) (-Math.floor(health) * 3.8F), 0xFFFF0000);
                    }

                    if (H2Eng.isFriend(player.getEntityName()))
                    {
                        H2Eng.drawBorderedRect(-28.0F, -75.6F, 27.0F, 8.0F, 1.5F, -16713223, 0);
                    }
                    else
                    {
                        H2Eng.drawBorderedRect(-28.0F, -75.6F, 27.0F, 8.0F, 1.5F, 0xffF01B1B, 0);
                    }
    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        double var35 = par1EntityLiving.lastTickPosX + (par1EntityLiving.posX - par1EntityLiving.lastTickPosX) * par3;
        ...
        if (this.occlusionEnabled && this.mc.gameSettings.advancedOpengl && !this.mc.gameSettings.anaglyph && par2 == 0)
        {
            ...
            var18 = var17 + this.renderSortedRenderers(var19, var20, par2, par3);
            ...
            do
            {
                ...
                for (int var25 = var21; var25 < var20; ++var25)
                {
                    ...
                    else
                    {
                        ...
                        {
                            float var26 = MathHelper.sqrt_float(this.sortedWorldRenderers[var25].distanceToEntitySquared(par1EntityLiving));
                            ...
                            if (this.cloudTickCounter % var27 == var25 % var27)
                            {
                                ...
                                ARBOcclusionQuery.glBeginQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB, this.sortedWorldRenderers[var25].glOcclusionQuery);
                ...
                this.theWorld.theProfiler.endStartSection("render");
                var18 += this.renderSortedRenderers(var21, var20, par2, par3);
            }
        ...
        {
            this.theWorld.theProfiler.endStartSection("render");
            var18 = var17 + this.renderSortedRenderers(0, this.sortedWorldRenderers.length, par2, par3);
        }
    ...
    public void renderSky(float par1)
    {
        ...
        {
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            Vec3 var23 = this.theWorld.getSkyColor(this.mc.renderViewEntity, par1);
            float var24 = (float)var23.xCoord;
            float var4 = (float)var23.yCoord;
            float var5 = (float)var23.zCoord;
            float var6;
            ...
            int var27 = this.theWorld.getMoonPhase(par1);
            int var28 = var27 % 4;
            var15 = var27 / 4 % 2;
            var16 = (float)(var28 + 0) / 4.0F;
            var17 = (float)(var15 + 0) / 2.0F;
            float var18 = (float)(var28 + 1) / 4.0F;
            ...
            var25.draw();
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            float var20 = this.theWorld.getStarBrightness(par1) * var6;
    ...
    public boolean updateRenderers(EntityLiving par1EntityLiving, boolean par2)
    {
        ...
        for (var13 = var3 - 1; var13 >= 0; --var13)
        {
            var14 = var5[var13];

            if (var14 != null)
            {
                if (!var14.isInFrustum && var13 != var3 - 1)
                {
                    var5[var13] = null;
                    var5[0] = null;
                    break;
                ...
                if (var5[var13].genChunkCacheCheck())
                {
                    var5[var13].updateRenderer();
                }
                else
                {
                    var5[var13].genChunkCache = false;
                }

                var5[var13].needsUpdate = false;
                ++var9;
            }
        }
        ...
        for (var12 = this.worldRenderersToUpdate.size(); var13 != var12; ++var13)
        {
            var14 = (WorldRenderer)this.worldRenderersToUpdate.get(var13);

            if (var14 != null)
            {
                boolean var15 = false;

                for (int var16 = 0; var16 < var3 && !var15; ++var16)
                {
                    if (var14 == var5[var16])
                    {
                        var15 = true;
                ...
                if (!var15)
                {
                    if (var11 != var13)
                    {
                        this.worldRenderersToUpdate.set(var11, var14);
                    }
        ...
        while (true)
        {
            ...
            this.worldRenderersToUpdate.remove(var13);
        }
    }
    ...
    public EntityFX func_72726_b(String par1Str, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                if (!par1Str.startsWith("blood") && !par1Str.startsWith("blockbreaking_") && !par1Str.startsWith("gilza"))
                {
                    if (!par1Str.startsWith("smoke") && !par1Str.startsWith("iconcrack_") && !par1Str.startsWith("2iconcrack_") && !par1Str.startsWith("3iconcrack_") && !par1Str.startsWith("iskri"))
                    {
                        if (par1Str.startsWith("explode"))
                        {
                            var22 = 64.0D;
                        }
                    }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var27 = Integer.parseInt(par1Str.substring(par1Str.indexOf("_") + 1));

                            if (var27 >= 1256 && var27 < 1512)
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Item.itemsList[var27], 4);
                            }
                            else if (var27 >= 1512 && var27 < 1768)
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Item.itemsList[var27], 5);
                            }
                            else
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Item.itemsList[var27], 2);
                            }
                        }
                        ...
                        else if (par1Str.equals("blood"))
                        {
                            var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, 3, 14, 4, 1);
                        }
                        else if (par1Str.startsWith("blockbreaking_"))
                        {
                            var27 = Integer.parseInt(par1Str.substring(par1Str.indexOf("_") + 1));
                            var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Block.blocksList[var27], 1, 2);
                        }
                        else if (par1Str.equals("iskri"))
                        {
                            if (var15 * var15 + var17 * var17 + var19 * var19 > 1.9599999999999997D)
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, 15, 15, 4, 3);
                            }
                        }
                        else if (par1Str.equals("iskri2"))
                        {
                            var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, 15, 15, 4, 4);
                        }
                        else if (par1Str.equals("gilza"))
                        {
                            var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, 0, 15, 4, 5);
                        }
                        else if (par1Str.equals("smoke2"))
                        {
                            var21 = new EntitySmokeFX(this.theWorld, par2, par4, par6, par8, par10, par12, 15.0F, 1);
                        }
                        else if (par1Str.equals("smoke3"))
                        {
                            var21 = new EntitySmokeFX(this.theWorld, par2, par4, par6, par8, par10, par12, 8.0F, 2);
                        }
                        else if (par1Str.equals("smoke4"))
                        {
                            var21 = new EntitySmokeFX(this.theWorld, par2, par4, par6, par8, par10, par12, 15.0F, 3);
                        }
                        else if (par1Str.startsWith("2iconcrack_"))
                        {
                            var27 = Integer.parseInt(par1Str.substring(par1Str.indexOf("_") + 1));

                            if (var27 >= 1256 && var27 < 1512)
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.itemsList[var27], 4);
                            }
                            else if (var27 >= 1512 && var27 < 1768)
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.itemsList[var27], 5);
                            }
                            else
                            {
                                var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.itemsList[var27], 2);
                            }
                        }
                        else if (par1Str.startsWith("3iconcrack_"))
                        {
                            var27 = Integer.parseInt(par1Str.substring(par1Str.indexOf("_") + 1));
                            var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, var27, 0, 4, 0);
                        }
                    }
        ...
        switch (par2)
        {
            ...
            case 2002:
                ...
                for (var16 = 0; var16 < 100; ++var16)
                {
                    ...
                    EntityFX var48 = this.func_72726_b(var34, var8 + var19 * 0.1D, var10 + 0.3D, var12 + var23 * 0.1D, var19, var21, var23);

                    if (var48 != null)
                    {
                        float var47 = 0.75F + var7.nextFloat() * 0.25F;
                        var48.setRBGColorF(var31 * var47, var32 * var47, var33 * var47);
                        var48.multiplyVelocity((float)var25);
                    }
                }
            ...
            case 2003:
                ...
                for (var35 = 0.0D; var35 < (Math.PI * 2D); var35 += 0.15707963267948966D)
                {
            ...
            case 2006:
                this.mc.effectRenderer.addBlockHitEffects2(par3, par4, par5, par6);
                break;

            case 2007:
                var16 = par6 & 4095;
                this.mc.effectRenderer.addBlockDestroyEffects2(par3, par4, par5, par6 & 4095, par6 >> 12 & 255);
                break;

            case 2008:
                for (var15 = 0; var15 < par6; ++var15)
                {
                    var35 = (double)par3 + 0.5D + ((double)this.theWorld.rand.nextFloat() - 0.5D) * 0.8D;
                    var37 = (double)par4 + 0.5D + ((double)this.theWorld.rand.nextFloat() - 0.5D) * 0.8D;
                    var39 = (double)par5 + 0.5D + ((double)this.theWorld.rand.nextFloat() - 0.5D) * 0.8D;
                    this.theWorld.spawnParticle("explode", var35, var37, var39, var7.nextGaussian() * 0.15D, var7.nextDouble() * 0.2D, var7.nextGaussian() * 0.15D);
                }
            ...
            case 2009:
                for (var15 = 0; var15 < par6; ++var15)
                {
                    var35 = (double)par3 + 0.5D + ((double)this.theWorld.rand.nextFloat() - 0.5D) * 0.3D;
                    var37 = (double)par4 + 1.0D + ((double)this.theWorld.rand.nextFloat() - 0.5D) * 0.6D;
                    var39 = (double)par5 + 0.5D + ((double)this.theWorld.rand.nextFloat() - 0.5D) * 0.3D;
                    this.theWorld.spawnParticle("explode", var35, var37, var39, var7.nextGaussian() * 0.07D, var7.nextDouble() * 0.1D, var7.nextGaussian() * 0.07D);
                }
        }
    }
    ...
    {
        return RenderGlobal.class.getSimpleName();
    }
}
